...
* [集成 SDK 和 API 导入](android-sdk.md#ji-cheng-sdk-he-api-dao-ru)
...
* [如何集成 1.x 版本 SDK](android-sdk.md#ru-he-ji-cheng-1x-ban-ben-sdk)

## 集成 SDK 和 API 导入

重要：如果您目前已经在使用[GrowingIO 1.x 版本的 SDK](android-sdk.md#ru-he-ji-cheng-1x-ban-ben-sdk)，希望升级到最新版本 \(V2.1），您需要联系您的 GrowingIO 对接人，我们需要帮您开启新版本 SDK 的功能。如果您忽略该提醒自助升级，而后台对应功能未开启的话，可能会带来数据丢失的问题。如何升级?
...
类似于用户属性字段，在 2.x 版本中，页面属性字段被迁移到了“[页面级变量](../data-model/event-variable/custom-variable.md#2)”。与页面属性字段不同的是，**页面级变量相当于过去的 PS 字段，不再存在过去的 PG 字段**。
...
![&#x9879;&#x76EE;&#x7BA1;&#x7406;](https://docs.growingio.com/.gitbook/assets/image%20%282%29.png)
