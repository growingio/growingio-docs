...
您的 APP 或网页在集成了 GrowingIO 的 SDK 之后，它将会自动地为您采集一系列用户行为数据，并在 GrowingIO 分析后台供您制成数据分析报表。除上述的用户行为数据（或称为无埋点数据）之外，GrowingIO 还提供了多种 API 接口，供您上传一些自定义的数据指标及维度，具体请参考[相关文档]()。
...
**如果您目前希望从 1.x 版本升级至 2.x 版本，请务必务必联系 GrowingIO 对接人，需要开启后台 2.x 版本所对应功能才可以继续操作！！**

**如果直接集成 2.x 版本，而后台对应功能未开启的话，可能会造成数据丢失的问题！！！**

### **1. 重新集成 SDK（请确保你已经联系 GrowingIO 对接人，并已开启后台对应功能，方可继续操作！！）** {#21}
