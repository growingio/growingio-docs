...
![&#x5E94;&#x7528;&#x7BA1;&#x7406;&#x5165;&#x53E3;](../../.gitbook/assets/image%20%2839%29.png)
...
dependencies {
    //GrowingIO 埋点 SDK
    implementation 'com.growingio.android:vds-android-agent:track-2.6.1@aar'
}
```
...
Android 埋点 SDK 功能相对于无埋点少了自动采集用户行为数据和页面元素信息。所以少了对应的接口。
