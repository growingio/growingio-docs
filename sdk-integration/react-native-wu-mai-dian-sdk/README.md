...
{% hint style="danger" %}
**注意将 SDK 版本号替换成 RN 版本:`RN-autotrack-2.8.5 。`**
{% endhint %}
...
1. 获取 [GrowingCoreKit](https://assets.growingio.com/sdk/ios/GrowingIO-iOS-CoreKit-2.8.5.zip)、[GrowingAutoTrackKit](https://assets.growingio.com/sdk/ios/GrowingIO-iOS-AutoTrackKit-2.8.5.zip)、[GrowingReactNativeKit](https://assets.growingio.com/sdk/ios/GrowingIO-iOS-ReactNativeKit-2.8.5.zip)、[GrowingHeader](https://assets.growingio.com/sdk/ios/GrowingIO-iOS-PublicHeader-2.8.5.zip)包
2. 解压上述 iOS SDK 压缩文件
