...
**注意：如果您是刚刚接入GrowingIO的用户，在使用「智能路径」帮助您分析之前，需要对您的转化目标进行「圈选」。**具体请参看功能介绍-[web圈选](../data-defination/events-metrics/circle-metrics/web-circle.md)或[移动端圈选](../data-defination/events-metrics/circle-metrics/app-circle.md)。
...
#### 3.6 为什么各条路径百分比之和不等于 100% ？ {#6为什么各条路径百分比之和不等于100？}
