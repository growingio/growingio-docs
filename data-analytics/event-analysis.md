...
* [2.事件分析介绍](https://growingio.gitbook.io/docs/data-analytics/event-analysis#2-shi-jian-fen-xi-jie-shao)
  ...
  * [2.2 纵向柱图](https://growingio.gitbook.io/docs/data-analytics/event-analysis#22-zong-xiang-zhu-tu)
  * [2.3 表格](https://growingio.gitbook.io/docs/data-analytics/event-analysis#23-biao-ge)
  * [2.4 横向柱图](https://growingio.gitbook.io/docs/data-analytics/event-analysis#24-heng-xiang-zhu-tu)
  * [2.5 数值图](https://growingio.gitbook.io/docs/data-analytics/event-analysis#25-shu-zhi-tu)
  * [2.6 气泡图](https://growingio.gitbook.io/docs/data-analytics/event-analysis#26-qi-pao-tu)
  * [2.7 维度线图](https://growingio.gitbook.io/docs/data-analytics/event-analysis#27-wei-du-xian-tu)
  * [2.8 维度柱图](https://growingio.gitbook.io/docs/data-analytics/event-analysis#28-wei-du-zhu-tu)
  * [2.9 周期对比线图](https://growingio.gitbook.io/docs/data-analytics/event-analysis#29-zhou-qi-dui-bi-xian-tu)
* [3.单图列表](https://growingio.gitbook.io/docs/data-analytics/event-analysis#3-dan-tu-lie-biao)

## 1.简介

### [1.1**什么是事件？**](event-analysis.md#1-1-shen-me-shi-shi-jian)
...
### [1.2**事件分析能解决什么问题？**](event-analysis.md#1-2) {#1-2}
...
## [2.**事件分析介绍**](event-analysis.md#2) {#2}
...
### [2.2 纵向柱图](event-analysis.md#22-zong-xiang-zhu-tu)
