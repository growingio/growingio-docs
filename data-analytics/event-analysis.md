...
在对多个目标用户群进行多事件指标、多维度分析时，表格将通过维度对事件指标拆分，并将各事件指标聚合在对应目标用户群下。

如未勾选时间维度，则按第一个目标用户群的第一个指标排序：

![](../.gitbook/assets/shi-jian.png)

如勾选时间维度， 则按时间维度进行排序：

![](../.gitbook/assets/mei-shi-jian%20%281%29.png)
