...
相关维度：  
UTM 参数现在有，广告来源（utm\_source），广告媒介（utm\_medium ），广告关键字（utm\_term ），广告内容（utm\_content ）。您可以参考[如下文章](../data-analytics/ads-tracking/utm-parameters/)去配置UTM渠道追踪。我们建议你可以使用[广告监测](../data-analytics/ads-tracking/)功能。
