...
我们重新设计了**广告监测下的报表**，将网站和移动端下的「基础数据」报表进行全面改版，在新版报表中增加多处数据可视化图表，方便活动推广人员更加便捷、直观的分析广告推广数据。同时支持添加「业务转化指标」，实现从广告获客阶段到最终转化完成的全链路数据分析。[查看更多详情。]()
...
我们为**小程序的数据定义人员**优化了展示头像的个数，方便用户更容易的定位到自己。[点击详情查看更多](data-definition/circle/minp.md#interactive-tagging-define-data)
