...
* [1.开始圈选](circle-web.md#1)
  * [1.1 定义页面](circle-web.md#1-1)
  * [1.2 定义元素](circle-web.md#1-2)
* [2.FAQ](circle-web.md#2)
  * [2.1 如何定义“一组同类元素之和”？](circle-web.md#2-1)
  * [2.2 对于已定义过的元素，更改定义规则后，应该如何保存？](circle-web.md#2-2)
  * [2.3 如何进行文本“内容”的模糊匹配？](circle-web.md#2-3)
  * [2.4 3月21日迭代后，新旧版本规则对应关系](circle-web.md#2-4)
* [3.圈选元素的新增文案（web）](circle-web.md#3)
  * [3.1 元素标签](circle-web.md#3-1)
  * [3.2 圈选到容器的情况](circle-web.md#3-2)
* [4.不能圈选的可能原因以及对应方法（web）](circle-web.md#4)
  * [4.1 不能圈选的原因](circle-web.md#4-1)
  * [4.2 data-growing-circle属性的使用帮助：](circle-web.md#4-2)
* [常见问题（web）](circle-web.md#chang-jian-wen-ti-web)
...
#### 2.1 如何定义“一组同类元素之和”？ {#2-1}

如果该元素有同类元素，不限定所有的限定条件，即是统计一组同类元素之和的数据。

#### 2.2 对于已定义过的元素，更改定义规则后，应该如何保存？ {#2-2}

更改新的规则后，如果原有数据仍然想继续统计，请选择“另存为”来定义新的规则。

#### 2.3 如何进行文本“内容”的模糊匹配？ {#2-3}
...
#### 4.2 data-growing-circle属性的使用帮助： {#4-2}
