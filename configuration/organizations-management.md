---
description: 强大而全面的组织管理功能，帮助企业在接入 GrowingIO 后对组织、项目和组织成员进行系统性的管理。
---
...
GrowingIO 提供了强大而全面的组织管理功能，帮助企业在接入 GrowingIO 后以组织为单位对组织、项目和组织成员进行系统性的管理。企业可以为组织成员分配组织成员角色，拥有组织管理权限的用户可以在任意界面点击右上角的齿轮按钮，进入组织管理界面。
