...
* **过去 7 天登录成员数：**展示了过去 7 天登录 GrowingIO 的组织成员总数，以及每天的登录用户数量；
* **过去 90 天每周登录成员数：**展示了过去 90 天登录 GrowingIO 的组织成员总数，以及每周的登录用户数量；
* **过去 7 天组织成员访问量：**展示了过去 7 天组织成员访问 GrowingIO 的总访问数量，以及每天组织成员的访问数量；
* **过去 90 天组织成员每周访问数：**展示了过去 90 天组织成员访问 GrowingIO 的总访问数量，以及每周组织成员的访问数量；
* **过去 90 天组织成员每周页面浏览量：**展示了过去 90 天组织成员在 GrowingIO上的页面浏览量，以及每周组织成员的页面浏览量；
* **过去 90 天组织成员每周访问时长：**展示了过去 90 天组织成员访问 GrowingIO的总访问时长，以及每周组织成员的访问时长；
* **过去 30 天组织成员访问量排名：**展示了过去 30 天组织成员访问 GrowingIO 的前十名用户；
* **过去 30 天组织成员每周访问量趋势：**展示了过去 30 天每周各个组织成员访问GrowingIO 数量；
* **过去 30 天最热看版：展**示了过去 30 天在所有组织项目中被组织成员浏览最多的前10名看板；
* **过去 30 天最热单圖：**展示了过去 30 天在所有组织项目中被组织成员浏览最多的前 10 名单图；
