...
* [2.数据报表](app-marketing.md#2-shu-ju-bao-biao)
  * [2.1 基础数据](app-marketing.md#21)
    * [2.1.1 数据指标概念](app-marketing.md#2-1-1-shu-ju-zhi-biao-gai-nian)
    * [2.1.2 全局设定](app-marketing.md#2-1-2-quan-ju-she-ding)
    * [2.1.3 激活设备数据](app-marketing.md#2-1-3-ji-huo-she-bei-shu-ju)
    * [2.1.4 广告活动和渠道效果分析](app-marketing.md#2-1-4-guang-gao-huo-dong-he-qu-dao-xiao-guo-fen-xi)
    * [2.1.5 推广日报](app-marketing.md#2-1-5-tui-guang-ri-bao)
    * [2.1.6 推广详细](app-marketing.md#2-1-6-tui-guang-xiang-xi)
...
* 激活：激活是指 App下载后首次联网打开 SDK 会上报一条该设备的激活数据，该指标可近似理解为 App 的下载安装量。
...
推广详细可查看各链接级别的详细统计数据，上方数据图表中的数据逻辑与该推广日报统计逻辑一致。
