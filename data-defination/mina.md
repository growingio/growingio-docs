...
## 预置自定义事件 {#yu-zhi-zi-ding-yi-shi-jian}
...
## 访问用户变量 {#fang-wen-yong-hu-bian-liang}
...
## 注册用户变量 {#zhu-ce-yong-hu-bian-liang}
