...
* [圈选定义页面级变量](mina-circle.md#define-page-dimensions)
...
1. 当前要圈选的小程序的产品名
2. 当前要圈选的小程序的 AppID
3. 当前要圈选的小程序中有数据被采集到的页面数量
4. 当前要圈选的小程序的过去 7 天数据表现
5. 当前要圈选的小程序自动采集到的页面列表及其数据
...
点击具体页面的容器区域，就会进入到该页面的行为指标定义页面，可以定义具体的行为指标了。
...
![&#x4E8B;&#x4EF6;&#x5206;&#x6790;&#x9009;&#x62E9;&#x6307;&#x6807;&amp;&#x7EF4;&#x5EA6;](../../../.gitbook/assets/image%20%2828%29.png)

![&#x56FE;&#x8868;&#x5448;&#x73B0;&#x7ED3;&#x679C;](../../../.gitbook/assets/image%20%2810%29.png)
